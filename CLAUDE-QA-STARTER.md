...
> **Cómo usar este archivo:** copialo tal cual como `CLAUDE.md` en la **raíz** del
> repositorio nuevo (vacío). Claude Code lo lee automáticamente en cada sesión.
> En la primera sesión, el agente construye el monorepo completo; después, te
> acompaña a escribir pruebas y regresiones bien hechas, y a generar y publicar
